...
## Discover ##
This project is based on a feasibility study :mag: in the context of the computer science master program at DHBW CAS :mortar_board: and a possible usecase of [OpenSemanticLab (OSL)](https://github.com/OpenSemanticLab) :microscope: